...
| Provide `supported_formats` with codec/rate/channels/bit depth | Done | [app/src/main/java/com/sendspinlite/SendspinPcmClient.kt](../app/src/main/java/com/sendspinlite/SendspinPcmClient.kt) (`buildPlayerSupportObject`) | Verify PCM and Opus entries in `client/hello` |
